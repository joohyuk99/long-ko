...
/**
 * Strings for component 'grades', language 'ko', branch 'MOODLE_39_STABLE'
 *
 * @package   grades
...
$string['enableoutcomes_help'] = '학습성과(신뢰성, 목표, 기준 혹은 표준)를 지원한다는 것은 학습성과 지침에 따른 하나 이상의 척도에 의거하여 성적을 산출한다는 것입니다. 학습성과를 활성화하면 그러한 특별한 성적 산출이 사이트 전반에 걸쳐 가능하게 됩니다.';
$string['encoding'] = '엔코딩';
