...
/**
 * Strings for component 'admin', language 'ko', branch 'MOODLE_39_STABLE'
 *
 * @package   admin
...
$string['configenableblogs'] = '블로그 활성화를 활성화하면 모든 사이트 사용자에게 자신만의 블로그를 제공합니다.';
...
$string['configenablerssfeeds'] = 'RSS 피드 활성화를 활성화할 경우 무들에서 자료를 RSS 방식으로 내보낼 수 있습니다. 각 모듈에서 RSS로 내보내려 한다면, 현재 어떤 상황인지를 살펴보고 안되면 관리자 환경설정 아래에 있는 모듈 설정에서 조정하십시오.';
...
$string['configenablestats'] = '통계 활성화를 활성화하면 무들의 일정관리 기능이 여러 기록과 통계를 수합합니다. 이 기능을 활성화할 경우, 여러분의 수업은 물론 사이트 전체에 관련된 여러 그래프와 통계를 볼 수 있습니다.';
...
$string['configusetags'] = '사이트 태그 기능 활성화';
...
$string['messagingcategory'] = '메시지 발송';
...
$string['messagingssettings'] = '메시지 설정';
$string['cronwarningnever'] = '<code>admin/cli/cron.php</code>스크립트가 실행된 적이 없으며, {$a->expected}마다 실행되어야 합니다.';
$string['mobilenotconfiguredwarning'] = '무들 앱이 활성화되지 않았습니다.';
$string['userfeedbackencouragement'] = '<p>무들 3.9에는 무들 HQ가 주최하는 외부 조사 사이트를 통해 무들 HQ에 무들 소프트웨어에 대한 피드백을 제공할 수 있는 선택권을 사용자에게 부여하는 새로운 기능이 포함되어 있습니다. 사용자 식별 정보는 조사 사이트로 전달되지 않습니다.</p>
<p>무들 HQ는 데이터 수집에 대해 개방적이고 투명해지기 위해 노력합니다. 따라서, 우리는 당신이 이 기능을 인지하고 통제하고 있는지 확인하고 싶습니다.</p>
<p>사용자로부터의 피드백은 무들 HQ가 무들 소프트웨어를 개선하는 데 큰 도움이 됩니다. 이 기능을 사용하려면 <a href="{$a}">피드백 설정</a>으로 이동하십시오.</p>';

$string['moodleservices_help'] = '다음 무들 서비스를 사용하여 무들 학습 환경을 최대한 활용하십시오.';
$string['moodlepartners_help'] = '<p>무들 파트너는 무들 HQ의 인증을 받은 서비스 제공자로서 당신의 온라인 학습 환경에 맞는 고품질 Moodle 서비스를 제공합니다.</p>
<a href="https://moodle.com/about-partners/">무들 파트너에 대하여</a><br />
<a href="https://moodle.com/partners">무들 파트너 찾기</a>';
$string['moodleapp_help'] = '<p>무료 무들 앱은 사용자들이 모바일 기기에서 그들의 강좌에 접속할 수 있도록 합니다. Pro 또는 Premium 앱 요금제와 함께 추가 앱 기능을 이용할 수 있습니다.</p>
<a href="https://moodle.com/mobile-app">무들 앱 받기</a><br />
<a href="https://apps.moodle.com">무들 앱 포털</a>';
$string['moodlebrandedapp'] = '브랜드 무들 앱';
$string['moodlebrandedapp_help'] = '<p>브랜드 무들 앱은 무료 무들 앱의 모든 기능을 사용자 지정 브랜드와 결합하여 제공합니다.</p>
<a href="https://moodle.com/branded-app">브랜드 무들 앱에 대하여</a>';
