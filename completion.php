...
/**
 * Strings for component 'completion', language 'ko', branch 'MOODLE_39_STABLE'
 *
 * @package   completion
...
$string['configenablecompletion'] = '이수과정 추적 활성화를 활성화하면, 강좌 수준에서 이수과정을 추적할 수 있게 됩니다.';
...
$string['completiondefault'] = '이수 추적';
$string['configcompletiondefault'] = '새 활동을 만들 때 이수 추적을 위한 기본 설정.';