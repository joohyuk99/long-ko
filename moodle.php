...
/**
 * Strings for component 'moodle', language 'ko', branch 'MOODLE_39_STABLE'
 *
 * @package   moodle
...
$string['forgotten'] = '아이디나 비밀번호를 잊으셨습니까?';
$string['forgottenduplicate'] = '이메일 주소가 여러 계정에 중복되어 있으므로 아이디를 대신 입력해 주십시오.';
...
$string['passwordforgotteninstructions2'] = '비밀번호를 재설정하기 위해서는 아래에 아이디나 이메일 주소를 입력하세요. 데이터베이스에서 확인이 되면 추후 과정을 안내할 이메일을 확인된 이메일 주소로 발송할 것입니다.';
...
$string['searchbyusername'] = '아이디로 찾기';
...
$string['updatemymoodleoff'] = '페이지 설정 마침';
$string['updatemymoodleon'] = '현재 페이지 설정';
...
$string['username'] = '아이디';
$string['usernameemail'] = '아이디/이메일';
$string['usernameemailmatch'] = '아이디와 이메일 주소는 다른 사용자와 같아서는 않됩니다.';
$string['usernameexists'] = '이 아이디는 이미 사용중입니다. 다른 아이디를 사용하세요.';
$string['usernamelowercase'] = '소문자만 허용됨';
$string['usernamenotfound'] = '아이디가 데이터베이스에 없습니다.';
$string['usernameoremail'] = '아이디나 이메일 주소를 입력';
...
$string['contentbank'] = '콘텐츠 저장소';
$string['privatefiles'] = '개인 파일';

//PLASS
$string['projectmanager'] = '웹 IDE';
$string['problembank'] = '문제 은행';