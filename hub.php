...
/**
 * Strings for component 'hub', language 'ko', branch 'MOODLE_39_STABLE'
 *
 * @package   hub
...
$string['registerwithmoodleorginfo'] = '우리는 당신의 무들 사이트를 위해 중요한 것들을 제공하고 싶습니다!

    * 신규 무들 릴리즈 알림, 보안 알림 및 기타 중요한 뉴스를 구독할 수 있습니다.
    * 무료 무들 앱을 통해 무들 사이트에서 모바을 알림에 접근하고 활성화할 수 있습니다.
    * 무들과 커뮤니티 사이트를 개선하는 데 기여할 수 있습니다.
    * 원한다면, 당신의 사이트는 당신의 나라에 등록된 무들 사이트 목록에 포함될 수 있습니다.';

$string['registerwithmoodleorginfoapp'] = '무들 앱에 대하여';
$string['registerwithmoodleorginfostats'] = '무들 통계';
$string['registerwithmoodleorginfosites'] = '우리나라의 다른 사이트';

$string['sitecommnews'] = '무들 뉴스레터';
$string['sitecommnewsno'] = '아니요, 이메일을 받고 싶지 않습니다.';
$string['sitecommnewsyes'] = '네, 무들 뉴스레터를 이메일로 받고 싶습니다.';

$string['usedifferentemail'] = '다른 이메일 사용';

$string['policyagreed'] = '개인정보 보호정책 및 데이터 처리 동의';
$string['policyagreeddesc'] = '<a href="{$a}" target="_blank">개인정보 보호정책 및 데이터 처리</a>에 동의합니다.';