...
/**
 * Strings for component 'message', language 'ko', branch 'MOODLE_39_STABLE'
 *
 * @package   message
...
$string['privacy:metadata:notifications'] = '알림';
$string['seeall'] = '전체 보기';
$string['nonotifications'] = '알림이 없습니다.';
$string['selectnotificationtoview'] = '자세히 보려면 알림을 선택하세요.';
